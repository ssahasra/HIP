...
kernel_mixed0(int *retval)
{
    ...
    result = __ockl_printf_append_string(result, msg, 1);
    retval[tid] = result;
}
...
kernel_mixed3(int *retval)
{
    ...
    desc = __ockl_printf_begin(0);
    result += __ockl_printf_append_string(desc, msg_long1, is_last);
    ...
    desc = __ockl_printf_begin(0);
    result += __ockl_printf_append_string(desc, msg_long2, is_last);
