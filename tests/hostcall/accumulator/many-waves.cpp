...
kernel_mixed2(int *retval)
{
    ...
    desc = __ockl_printf_begin(0);
    result += __ockl_printf_append_string_n(desc, msg[tid % 3], test_strlen(msg[tid % 3]) + 1, is_last);
    ...
    desc = __ockl_printf_begin(0);
    result +=
        __ockl_printf_append_string_n(desc, msg[(tid + 1) % 3], test_strlen(msg[(tid + 1) % 3]) + 1, is_last);

    desc = __ockl_printf_begin(0);
    result +=
        __ockl_printf_append_string_n(desc, msg[(tid + 2) % 3], test_strlen(msg[(tid + 2) % 3]) + 1, is_last);
